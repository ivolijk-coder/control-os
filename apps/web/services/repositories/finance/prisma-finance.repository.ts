import { AccountKind, AccountStatus, CategoryStatus, FixedAccountOccurrenceStatus, FixedAccountOrigin, FixedAccountPaymentMethod, FixedAccountRecurrence, Prisma, TransactionOrigin, TransactionSource, TransactionStatus, TransactionType, TransferDirection } from '@prisma/client';
...
function toFixedOrigin(value: import('@control-os/types').FixedAccountOrigin): FixedAccountOrigin { return value === 'empresa' ? FixedAccountOrigin.BUSINESS : value === 'outros' ? FixedAccountOrigin.OTHER : FixedAccountOrigin.PERSONAL; }
function fromFixedOrigin(value: FixedAccountOrigin): import('@control-os/types').FixedAccountOrigin { return value === FixedAccountOrigin.BUSINESS ? 'empresa' : value === FixedAccountOrigin.OTHER ? 'outros' : 'pessoal'; }
