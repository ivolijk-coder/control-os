...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Falha ao listar contas fixas.', error);
    return fail('Não foi possível carregar as contas fixas agora. Tente novamente em instantes.', 500);
  }
}
